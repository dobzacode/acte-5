...
import daniel_pic from '/public/assets/event/a-propos/daniel_chambet_ithier.jpg';
import sophie_pic from '/public/assets/event/a-propos/sophie_brobecker.jpg';
import yannique_pic from '/public/assets/event/a-propos/yannique_antrope.jpg';
        ...
        >
          ...
          <CarouselContent className="laptop-large:-ml-sm">
            {imageArr.map((image, index) => (
              <CarouselItem
                key={index}
                className="basis-full overflow-hidden mobile-large:basis-1/2 tablet:basis-1/3 laptop:basis-1/4 laptop-large:basis-1/5 laptop-large:pr-sm"
              >
                <div
                  className={cn(
