      ...
      >
        ...
        <div className="flex flex-col gap-md">
          ...
          <p className="body text-pretty">
            ...
            illustrer une problématique à vos parties prenantes, Acte 5 écrit pour vous des sketches
            sur mesure, intimement liés à votre sujet. La mise en scène de ces messages s’adapte à
            votre événement. Cette écriture spécifique est un réel outil qui favorise la prise de
            conscience.
          </p>
        </div>
        {/* <div className="flex flex-col gap-md">
