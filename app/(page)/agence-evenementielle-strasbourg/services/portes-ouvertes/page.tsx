      ...
      >
        ...
        <div className="flex flex-col gap-md">
          ...
          <p className="body text-pretty">
            ...
            feutrée selon vos goûts laissera, à vos visiteurs, une impression forte évoluant dans un
            univers harmonieux, festif, ou encore inattendu. A chaque étape nous sommes présents
            pour assurer l&apos;ordonnancement optimal de l&apos;événement. Bref, un déroulé sans
            fausse note.
          </p>
        </div>
        <div className="flex flex-col gap-md">
          ...
          <p className="body text-pretty">
            ...
            Désolé, nous ne faisons pas les animaux sauvages (quoi que… ). Imaginer un décor pour la
            circonstance, l&apos;accompagner de vidéo et de musique, l&apos;habiller de lumière…
            Nous répondons à toutes vos envies. Votre espace devient un lieu de découverte, les
            participants et les invités évoluent dans un cadre accueillant, propice à
            l&apos;exploration.
          </p>
        </div>
      </DivWrapper>
