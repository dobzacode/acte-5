        ...
        >
          ...
          <div className="flex flex-col gap-md">
            ...
            <p className="body text-pretty">
              ...
              faut pour faire de votre anniversaire un moment unique et sur mesure !
            </p>
          </div>
          <div className="flex flex-col gap-md">
            ...
            <p className="body text-pretty">
              ...
              diverses. Elle grandit en cultivant sa mémoire. L&apos;anniversaire est
              l&apos;événement idéal pour rappeler le positionnement et l&apos;évolution de
              l&apos;entreprise au sein d&apos;un environnement en mutation. L&apos;historique de
              ses activités, de son évolution, les moments forts de son existence témoignent
              d&apos;un savoir-faire capable de rassurer ses partenaires et de fidéliser encore plus
              ses collaborateurs.
              <br />
              <br /> Célébrer un anniversaire permet à l&apos;entreprise d&apos;immerger ses
              partenaires dans son intimité et ainsi dévoiler son âme.
            </p>
          </div>
        </DivWrapper>
      </section>
