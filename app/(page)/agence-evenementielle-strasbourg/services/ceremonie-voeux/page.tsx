      ...
      >
        ...
        <div className="flex flex-col gap-md">
          ...
          <p className="body text-pretty">
            ...
            l&apos;année écoulée, de vos actions passées et de souhaiter tous vos meilleurs vœux aux
            personnes qui vous entourent pour cette nouvelle année qui démarre.
            <br />
            <br />
            Mise en scène des valeurs de votre entreprise, cette cérémonie des vœux vous permet de
            faire des annonces, de dévoiler vos actions prochaines, de fixer de nouveaux objectifs,
            de vous projeter dans l&apos;avenir. La rencontre de vos équipes, parfois
            d&apos;horizons divers, dans un environnement détendu est l&apos;occasion de les fédérer
            et de les encourager à relever des défis renouvelés.
          </p>
        </div>
        <div className="flex flex-col gap-md">
          ...
          <p className="body text-pretty">
            ...
            un moment chaleureux partagé avec ceux qui participent à la vie de votre entreprise. Que
            ce soit dans vos locaux ou dans un lieu spécialement trouvé pour l&apos;occasion, nous
            favorisons une présentation élaborée avec soin. Vous avez des idées, partagez-les avec
            nous. Une panne d&apos;inspiration ? Nous proposons, nous concevons avec vous, vous
            validez.
            <br />
            ...
            concordance avec leur image. Une mise en lumière, une animation particulière, créer les
            invitations, dessiner un logo, nous vous offrons un large choix de prestations selon les
            tendances et les envies.
          </p>
        </div>
      </DivWrapper>
    </main>
